...
def assign_hyp_param(args, params):
    ...
    if args.method == 'tem':
        args.tem_args = params
    if args.method == 'ssm':
        args.ssm_args = params
    if args.method == 'tpp':
        args.tpp_args = params
    if args.method == 'mip':
        args.mip_args = params
    if args.method == 'imp':
        args.imp_args = params
    if args.method == 'tcpp':
        args.tcpp_args = params
    if args.method == 'ssrmergnn':
        args.ssrmergnn_args = params
    if args.method == 'puma':
        args.puma_args = params
    if args.method == 'cat':
        args.cat_args = params
    if args.method == 'agc':
        args.agc_args = params
    if args.method == 'fscil':
        args.fscil_args = params
    if args.method == 'pool':
        args.pool_args = params
